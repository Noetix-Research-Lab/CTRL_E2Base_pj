...
public:
    Frame(const std::shared_ptr<RobotModel>& robot_model,
        ...
        const int waist_freedom = robot_model->waist_freedom;
        robot_state = std::make_shared<RobotState>(single_arm_freedom, single_leg_freedom, waist_freedom);
        joint_cmd_ = std::make_shared<JointCommand>(single_arm_freedom, single_leg_freedom, waist_freedom);
        walk_phase_trans_data = std::make_shared<WalkPhaseTransitionData>(single_arm_freedom, single_leg_freedom, waist_freedom);
