...
export RECORD_TIMING=${RECORD_TIMING:-false}
export TIMING_LABEL=${TIMING_LABEL:-async}
export TIMING_WARMUP=${TIMING_WARMUP:-5}
export TIMING_DURATION=${TIMING_DURATION:-60}
export TIMING_WAIT_TIMEOUT=${TIMING_WAIT_TIMEOUT:-120}
export TIMING_OUTPUT_DIR=${TIMING_OUTPUT_DIR:-timing_results}
...
export POLICY_FILE_DANCE=${POLICY_FILE_DANCE:-${RL_CONTROLLERS_PATH}/policy/e2/policyDance_23dof.onnx}
export MOTION_FILE=${MOTION_FILE:-${RL_CONTROLLERS_PATH}/motion_files/e2/yinggewu_23dof.json}
...
roslaunch rl_controllers ac_start_real.launch \
  ...
  timing_wait_timeout:=${TIMING_WAIT_TIMEOUT} \
