...
public:
    ...
    std::size_t expectedInputBytes() const noexcept override { return sizeof(ImuRcData); }
    std::size_t expectedOutputBytes() const noexcept override { return sizeof(ImuRcCommand); }
